...
export function HobbitFooter({ brand, tagline, links, copyright }: HobbitFooterProps) {
  return (
    <footer className="bg-hobbit-forest-dark px-10 pb-5 pt-7">
      <div className="mx-auto flex max-w-[1200px] flex-col gap-6 md:flex-row md:items-start md:justify-between">
        <div>
        ...
        <nav aria-label="Footer">
          <ul className="flex list-none flex-wrap gap-4 p-0 m-0 md:justify-end">
            {links.map((link) => (
              <li key={link.href}>
                <a
                  href={link.href}
      ...
      {copyright ? (
        <div className="mx-auto mt-4 max-w-[1200px] border-t border-hobbit-forest-base pt-3">
